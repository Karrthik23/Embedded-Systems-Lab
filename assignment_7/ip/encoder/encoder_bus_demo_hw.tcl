...
set_module_property NAME encoder_bus_demo
set_module_property VERSION 1.0
set_module_property GROUP Templates
set_module_property AUTHOR Moll
set_module_property DISPLAY_NAME encoder_bus_demo
set_module_property TOP_LEVEL_HDL_FILE encoder_bus_demo.v
set_module_property TOP_LEVEL_HDL_MODULE encoder_bus_demo
...
##  
add_file encoder_bus_demo.v {SYNTHESIS SIMULATION}
...
add_parameter ENCODER_WIDTH int 16 "Encoder Output"
set_parameter_property ENCODER_WIDTH DISPLAY_NAME "Encoder"
set_parameter_property ENCODER_WIDTH GROUP "NANO Properties"
set_parameter_property ENCODER_WIDTH AFFECTS_PORT_WIDTHS true
set_parameter_property ENCODER_WIDTH ALLOWED_RANGES  {8 16 32}
...
add_interface_port user_interface counter export Output 16
add_interface_port user_interface enc_a export Input 1
add_interface_port user_interface enc_b export Input 1
...
proc elaborate_me {}  {
  ...
  set the_led_width  [get_parameter_value ENCODER_WIDTH]
