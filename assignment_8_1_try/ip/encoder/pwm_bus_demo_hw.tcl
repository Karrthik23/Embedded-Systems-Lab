...
set_module_property NAME pwm_bus_demo
set_module_property VERSION 1.0
set_module_property GROUP Templates
set_module_property AUTHOR Moll
set_module_property DISPLAY_NAME pwm_bus_demo
set_module_property TOP_LEVEL_HDL_FILE pwm_bus_demo.v
set_module_property TOP_LEVEL_HDL_MODULE pwm_bus_demo
...
##  
add_file pwm_bus_demo.v {SYNTHESIS SIMULATION}
add_file pwm_module.v {SYNTHESIS SIMULATION}
...
##
add_parameter DATA_WIDTH int 16 "Data width for avalon interface"
...
add_parameter pwm_WIDTH int 16 "pwm Output"
set_parameter_property pwm_WIDTH DISPLAY_NAME "pwm"
set_parameter_property pwm_WIDTH GROUP "NANO Properties"
set_parameter_property pwm_WIDTH AFFECTS_PORT_WIDTHS true
set_parameter_property pwm_WIDTH ALLOWED_RANGES  {8 16 32}
...
add_interface_port user_interface pwm_out export Output 1
add_interface_port user_interface channel_A export Output 1
add_interface_port user_interface channel_B export Output 1
...
proc elaborate_me {}  {
  ...
  set the_led_width  [get_parameter_value pwm_WIDTH]
  ...
  ## (counter not used anymore — line retained if added back later)
  # set_port_property counter WIDTH $the_led_width
